...
--->
<cfcomponent extends="farcry.core.packages.types.types" displayName="Google Map" hint="Display Google maps on the website" bFriendly="1" bobjectbroker="true" objectbrokermaxobjects="1000">
