<cfcomponent extends="farcry.farcry_core.packages.types.types" displayName="Google Map Location" hint="Google Map Location" bFriendly="1" bobjectbroker="true" objectbrokermaxobjects="1000">
	...
	<cfproperty ftSeq="3" ftFieldSet="Longitude and Latitude" name="LongLat" type="string" hint="Longitude and latitude of the map location" required="true" ftLabel="Longitude and Latitude" ftType="longLat" />
